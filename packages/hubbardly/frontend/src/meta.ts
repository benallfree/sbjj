...
import { faRotate, faServer, faArrowAltCircleDown } from '@fortawesome/free-solid-svg-icons'
	...
	plans: {
		...
		tiers: [
			...
			},
			{
				...
				description:
					'Unlock the full potential of Hubbardly with our Pro plan. Get access to all community recipes and match with your pantry items.',
				features: ['Everything in Pro, plus...', 'Save 20% with an annual subscription'],
				locked: true
			},
			{
				name: 'Founder',
